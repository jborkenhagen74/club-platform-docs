...
For Club Platform 1.0 Pilot use [the V3 guide](../docs/de/module-entwicklung-ohne-core.md) and `sdk/include/clubplatform/extension_v3.h`. The following ABI-2 material is retained only for historical compatibility.
